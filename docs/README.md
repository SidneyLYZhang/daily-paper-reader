...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-25 22:48:18 UTC<br>状态：成功</p>
</section>
...
<p>今日精读1篇、速读9篇，重点锁定涌现对称商的 information geometry 研究。最值得看的是该文以8.0分领跑，探讨对称商及其弱展开的几何结构；速读中机器人行为对齐动作分词与表示世界模型也值得关注。普通读者可先从精读文章理解几何视角，再按兴趣浏览速读方向。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Information geometry of emergent symmetry quotients and their weak unfoldings">Information geometry of emergent symmetry quotients and their weak unfoldings</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Scaling limits for Moran processes on metric strategy spaces: an Eulerian derivation of pure replicator and Fleming--Viot measure-valued PDEs">Scaling limits for Moran processes on metric strategy spaces: an Eulerian derivation of pure replicator and Fleming--Viot measure-valued PDEs</span></li><li><span class="dpr-home-dashboard-paper-title" title="Behavior-Aligned Action Tokenization for Robot Policy Learning">Behavior-Aligned Action Tokenization for Robot Policy Learning</span></li><li><span class="dpr-home-dashboard-paper-title" title="Representation World Model: Learning States, Transition and Executable Plans in Representation">Representation World Model: Learning States, Transition and Executable Plans in Representation</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">ml-theory <strong>4</strong></span><span class="dpr-home-dashboard-tag">rl-semantic <strong>4</strong></span><span class="dpr-home-dashboard-tag">npl-bdl-saig <strong>1</strong></span></div>
</section>
</div>
