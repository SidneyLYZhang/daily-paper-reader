...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-23 22:48:42 UTC<br>状态：成功</p>
</section>
...
<p>精读：《Theory for groupoid equivariant neural networks: an approach for steerable CNNs on bounded domains》（8.0/10）</p>
<p>速读：《Benign Nonconvex Landscape for Policy Optimization: Infinite-Horizon Discounted MDPs with General State and Action Spaces》（7.0/10）, 《Combinatorial Network-Based Manifold Topological Deep Learning for Image Analysis》（7.0/10）, 《Convergence of Rotation-based Matrix Optimizers: A Unified Analysis of SOAP, Conda, and SPlus》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Theory for groupoid equivariant neural networks: an approach for steerable CNNs on bounded domains">Theory for groupoid equivariant neural networks: an approach for steerable CNNs on bounded domains</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Benign Nonconvex Landscape for Policy Optimization: Infinite-Horizon Discounted MDPs with General State and Action Spaces">Benign Nonconvex Landscape for Policy Optimization: Infinite-Horizon Discounted MDPs with General State and Action Spaces</span></li><li><span class="dpr-home-dashboard-paper-title" title="Combinatorial Network-Based Manifold Topological Deep Learning for Image Analysis">Combinatorial Network-Based Manifold Topological Deep Learning for Image Analysis</span></li><li><span class="dpr-home-dashboard-paper-title" title="Convergence of Rotation-based Matrix Optimizers: A Unified Analysis of SOAP, Conda, and SPlus">Convergence of Rotation-based Matrix Optimizers: A Unified Analysis of SOAP, Conda, and SPlus</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">ml-theory <strong>5</strong></span></div>
</section>
</div>
